...
class PeliculasController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        peliculas.append(Pelicula(titulo: "Interstellar", año: "2014", director: "Christopher Nolan", genero: "Sci-fi/Aventura", imagen: "interstellar", productora: "Paramount Pictures", rating: "8.6", recaudacion: "701.7M USD", presupuesto: "165M USD", duracion: "2h 49m"))
        peliculas.append(Pelicula(titulo: "The Godfather", año: "1972", director: "Francis Ford Coppola", genero: "Crimen/Thriller", imagen: "the-godfather", productora: "Paramount Pictures", rating: "9.2", recaudacion: "291M USD", presupuesto: "6M USD", duracion: "2h 55m"))
        peliculas.append(Pelicula(titulo: "The Godfather: Part II", año: "1974", director: "Francis Ford Coppola", genero: "Crimen/Drama", imagen: "the-godfather-2", productora: "Paramount Pictures", rating: "9", recaudacion: "93M USD", presupuesto: "13M USD", duracion: "3h 20m"))
        peliculas.append(Pelicula(titulo: "The Godfather: Part III", año: "1990", director: "Francis Ford Coppola", genero: "Crimen/Drama", imagen: "the-godfather-3", productora: "Paramount Pictures", rating: "7.6", recaudacion: "136.9M USD", presupuesto: "54M USD", duracion: "2h 42m"))
        peliculas.append(Pelicula(titulo: "The Social Network", año: "2010", director: "David Fincher", genero: "Drama/Historia", imagen: "the-social-network", productora: "Trigger Street Productions", rating: "7.8", recaudacion: "224.9M USD", presupuesto: "40M USD", duracion: "2h"))
        peliculas.append(Pelicula(titulo: "Goodfellas", año: "1990", director: "Martin Scorsese", genero: "Crimen/Drama", imagen: "goodfellas", productora: "Warner Brothers", rating: "8.7", recaudacion: "47.1M USD", presupuesto: "25M USD", duracion: "2h 26m"))
        peliculas.append(Pelicula(titulo: "The Wolf of Wall Street", año: "2013", director: "Martin Scorsese", genero: "Comedia/Drama", imagen: "the-wolf-of-wallstreet", productora: "Paramount Pictures", rating: "8.2", recaudacion: "392M USD", presupuesto: "100M USD", duracion: "3h"))
        peliculas.append(Pelicula(titulo: "Scarface", año: "1983", director: "Brian De Palma", genero: "Crimen/Drama", imagen: "scarface", productora: "Universal Studios", rating: "8.3", recaudacion: "66M USD", presupuesto: "25M USD", duracion: "2h 50m"))
        peliculas.append(Pelicula(titulo: "Pulp Fiction", año: "1994", director: "Quentin Tarantino", genero: "Crimen/Drama", imagen: "pulp-fiction", productora: "Miramax", rating: "8.9", recaudacion: "213.9M USD", presupuesto: "8.5M USD", duracion: "2h 43"))
        peliculas.append(Pelicula(titulo: "Inglorious Basterds", año: "2009", director: "Quentin Tarantino", genero: "Guerra/Accion", imagen: "inglorious-basterds", productora: "Universal Studios", rating: "8.3", recaudacion: "321.5M USD", presupuesto: "70M USD", duracion: "2h 33m"))
        peliculas.append(Pelicula(titulo: "Forrest Gump", año: "1994", director: "Robert Zemeckis", genero: "Drama/Romance", imagen: "forrest-gump", productora: "Paramount Pictures", rating: "8.8", recaudacion: "678.2M USD", presupuesto: "55M USD", duracion: "2h 22m"))
        peliculas.append(Pelicula(titulo: "Hereditary", año: "2018", director: "Ari Aster", genero: "Horror/Drama", imagen: "hereditary", productora: "A24", rating: "7.3", recaudacion: "80.2M USD", presupuesto: "10M USD", duracion: "2h 7m"))
        peliculas.append(Pelicula(titulo: "Midsommar", año: "2019", director: "Ari Aster", genero: "Horror/Thriller", imagen: "midsommar", productora: "B-Reel Films", rating: "7.1", recaudacion: "47.8M USD", presupuesto: "9M USD", duracion: "2h 51m"))
        peliculas.append(Pelicula(titulo: "Southpaw", año: "2015", director: "Antoine Fuqua", genero: "Drama/Thriller", imagen: "southpaw", productora: "DreamWorks", rating: "7.3", recaudacion: "94M USD", presupuesto: "30M USD", duracion: "2h 42m"))
        peliculas.append(Pelicula(titulo: "Whiplash", año: "2014", director: "Damien Chazelle", genero: "Drama", imagen: "whiplash", productora: "Blumhouse Productions", rating: "8.5", recaudacion: "49M USD", presupuesto: "3.3M USD", duracion: "1h 47m"))
